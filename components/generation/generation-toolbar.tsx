...
export function GenerationToolbar({
  ...
  const pillActive = `${pillCls} border-brand-200/60 dark:border-brand-700/50 bg-brand-100 dark:bg-brand-900/30 text-brand-700 dark:text-brand-300`;
        ...
        <PopoverTrigger asChild>
          {pdfFile ? (
            <button className={pillActive}>
              ...
              <span
                role="button"
                className="size-4 rounded-full inline-flex items-center justify-center hover:bg-brand-200 dark:hover:bg-brand-800 transition-colors"
                onClick={(e) => {
                  e.stopPropagation();
          ...
          <PopoverContent align="start" className="w-64 p-3 space-y-3">
            ...
            >
              <Globe2
                className={cn(
                  'size-4 shrink-0',
                  webSearch ? 'text-brand-600 dark:text-brand-400' : 'text-muted-foreground',
                )}
              />
          ...
          <PopoverTrigger asChild>
            <button
              className={cn(
                ...
                currentModelId &&
                  'ring-brand-300 dark:ring-brand-700 bg-brand-50 dark:bg-brand-950/20',
              )}
            >
              ...
              return (
                <button
                  ...
                  className={cn(
                    ...
                    isActive ? 'bg-brand-50/50 dark:bg-brand-950/10' : 'hover:bg-muted/50',
                  )}
                >
                  {provider.icon ? (
                    <img

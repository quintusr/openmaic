  ...
  return (
    <Card className="p-5 !gap-0 shadow-xl border-muted/40 backdrop-blur-xl bg-white/80 dark:bg-slate-900/80">
      ...
      <div className="flex items-center gap-3.5">
        ...
        >
          <div className="size-11 rounded-full bg-gray-50 dark:bg-gray-800 overflow-hidden ring-2 ring-brand-300/50 dark:ring-brand-600/40 group-hover/avatar:ring-brand-400 dark:group-hover/avatar:ring-brand-500 transition-all">
          ...
          {editingName ? (
            <div className="flex items-center gap-1.5">
              <input
                ...
                className="flex-1 min-w-0 h-7 bg-transparent border-b-2 border-brand-400 dark:border-brand-500 text-sm font-semibold text-foreground outline-none placeholder:text-muted-foreground/40"
              />
              <button
                onClick={commitName}
                className="shrink-0 size-6 rounded-md flex items-center justify-center text-brand-500 hover:bg-brand-100 dark:hover:bg-brand-900/30 transition-colors"
              >
              ...
              {AVATAR_OPTIONS.map((url) => (
                <button
                  ...
                  className={cn(
                    ...
                    avatar === url
                      ? 'ring-2 ring-brand-400 dark:ring-brand-500 ring-offset-1 ring-offset-white dark:ring-offset-slate-900'
              ...
              <label
                ...
                className={cn(
                  ...
                  isCustomAvatar(avatar)
                    ? 'ring-2 ring-brand-400 dark:ring-brand-500 ring-offset-1 ring-offset-white dark:ring-offset-slate-900 border-brand-300 dark:border-brand-600 bg-brand-50 dark:bg-brand-900/30'

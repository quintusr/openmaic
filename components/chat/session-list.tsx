...
const sessionBadgeStyles = {
  ...
  lecture: 'bg-brand-100 text-brand-700 dark:bg-brand-900/30 dark:text-brand-300',
};
        ...
        return (
          <div
            ...
            className={cn(
              ...
              isActive
                ? 'border-brand-200 dark:border-brand-700 bg-brand-50/30 dark:bg-brand-900/20 shadow-sm'
